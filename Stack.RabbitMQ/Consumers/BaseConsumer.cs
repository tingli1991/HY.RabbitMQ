...
namespace Stack.RabbitMQ.Consumers
{
    ...
    class BaseConsumer
    {
        ...
        /// 日志记录器
        /// </summary>
        private static readonly ILog _log = Log4Context.GetLogger<BaseConsumer>();
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// <param name="eventArgs"></param>
        protected virtual void SuccessHandler(object sender, ResponseResult result, BasicDeliverEventArgs eventArgs)
        {
